...
export const metadata: Metadata = {
  ...
  description: 'Long 1986 V2 ProApp cho livestream, Mixer, AI và điều phối.',
  ...
  appleWebApp: { capable: true, title: 'Long ProApp', statusBarStyle: 'default' },
...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  return (
    <html lang="vi" suppressHydrationWarning data-app-profile="pro">
      <head>
